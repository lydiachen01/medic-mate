            ...
            <div className="max-w-sm w-full space-y-8 bg-white/80 backdrop-blur-sm rounded-xl border border-slate-200 shadow-[0_8px_30px_rgb(0,0,0,0.12)] p-8">
                <div>
                    <h2 className="text-3xl font-bold text-center bg-gradient-to-r from-blue-500 to-pink-500 text-transparent bg-clip-text">
                        Welcome back! <span aria-hidden="true" className='text-slate-100'>👋</span>
                    </h2>
                    <p className="mt-2 text-center text-sm text-gray-600">
                        New?{' '}
                        <Link href="/user/signup" className="font-medium text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-pink-500 hover:opacity-80">
                            Register a new account <span aria-hidden="true" className='text-slate-100'>✨</span>
                        </Link>
                    </p>
                </div>
