...
const AddMedication: React.FC = () => {
    ...
    return (
        <div className="space-y-8">
            <div className="bg-gradient-to-br from-pink-50 to-blue-50 rounded-2xl shadow-lg p-8 border-2 border-pink-200 transform transition-all hover:shadow-xl">
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="border-2 border-dashed border-blue-300 rounded-xl p-6 text-center bg-white/70 hover:bg-white/90 transition-all duration-300 transform hover:scale-[1.01]">
                        ...
                        >
                            {previewUrl ? (
                                <div className="relative w-full h-48 mx-auto rounded-lg overflow-hidden shadow-inner">
                                    <Image
                                        src={previewUrl}
                                        alt="Preview"
                                        fill
                    ...
                    <button
                        type="submit"
                        className="w-full bg-gradient-to-r from-orange-400 via-pink-400 to-blue-400 text-white py-3 px-4 rounded-xl hover:from-orange-500 hover:via-pink-500 hover:to-blue-500 transition-all duration-300 font-medium shadow-md disabled:opacity-50 disabled:cursor-not-allowed transform hover:scale-[1.02] active:scale-[0.98]"
            ...
            {extractedText && (
                <div className="p-4 bg-white/70 rounded-xl border border-blue-200 shadow-lg">
                    <h2 className="text-lg font-semibold text-blue-600 mb-3 flex items-center space-x-2">
                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
